...
class MyDriver
{
   public static void main(String[] args)
   {
     //cretaes an object of grocery list and add the listed items to the list
      GroceryList list = new GroceryList();
      list.add("BEER", 9.99, "8/20/2022");
      list.add("CANDY'S", 15.99, "6/20/2023");
      list.add("BEEF", 7.99, "9/8/2022");
      list.add("LAYS", 7.99, "7/7/2025");
      ...
      System.out.println();
      System.out.println("Removing Bread from the list and adding a new item on the list in the 3rd node");
      list.remove("CANDY'S");//using the remove method to remove Donumts from list
